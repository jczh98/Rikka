package top.rechinx.rikka.preference
...
inline fun PreferenceGroup.switchPreferenceCompat(block: (@DSL SwitchPreferenceCompat).() -> Unit): SwitchPreferenceCompat {
    return initThenAdd(SwitchPreferenceCompat(context), block)
}

inline fun PreferenceGroup.switchPreference(block: (@DSL SwitchPreference).() -> Unit): SwitchPreference {
